"remove" in Element.prototype || (Element.prototype.remove = function () {
  ...
  m.widget("flowchart.flowchart", {
    ...
    _autoCreateSubConnector: function (t, e, o, r) {
      var n = Object.values(this.data.operators).find(x => x.id == t).internal.properties[o][e];
      if (n.multiple)
        for (var a = Object.values(this.data.operators).find(x => x.id == t).internal.els, i = Object.values(this.data.operators).find(x => x.id == t).internal.els.connectors[e].length; i < r + 2; i++) this._createSubConnector(e, n, a)
    },
    ...
    getConnectorPosition: function (t, e, o) {
      var r = Object.values(this.data.operators).find(x => x.id == t).internal.els.connectorArrows[e][o],
        n = r.offset(),
    ...
    _drawLink: function (t) {
      ...
      var o = e.fromOperator,
        ...
        s = i[0],
        l = i[1],
        p = (this.getLinkMainColor(t), Object.values(this.data.operators).find(x => x.id == o)),
        c = Object.values(this.data.operators).find(x => x.id == n),
    ...
    _getOperatorFullElement: function (t) {
      ...
      var rr = m('<div class="flowchart-operator-title-span"></div>');
      r.html(rr)

      rr.html(e.title), r.appendTo(o);
    ...
    addOperator: function (t) {
      for (; void 0 !== Object.values(this.data.operators).find(x => x.id == this.operatorNum);) this.operatorNum++;
    ...
    createOperator: function (t, a) {
      ...
      e && (a.top = Math.round(a.top / e) * e, a.left = Math.round(a.left / e) * e), i.operator.appendTo(this.objs.layers.operators), i.operator.css({
        top: function () {
          if (a.top) {
            return (document.querySelector('.flowchart-container').offsetHeight / 3) + a.top
          } else {
        ...
        left: function () {
          if (a.left) {
            return (document.querySelector('.flowchart-container').offsetWidth / 2) + a.left
          } else {
